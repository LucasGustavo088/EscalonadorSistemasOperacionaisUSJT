package usjt.escalonamento.escalonadores;
...
/**
 * Escalona os processos de acordo com o tempo de execução
 */
public class SJF extends Escalonador {
    ...
    /**
     * Inicializa um SJF informando se é preemptivo, e alguns/todos processos
     * que serão escalonados.
     * 
     * @param preemptivo
    ...
    /**
     * Inicializa um SJF informando se é preemptivo.
     * 
     * @param preemptivo
     *            Se é preemptivo ou não-preemptivo
     */
    ...
    /**
     * Inicializa um SJF informando alguns/todos processos que serão
     * escalonados.
     * 
     * @param processos
     *            Processos por escalonar
